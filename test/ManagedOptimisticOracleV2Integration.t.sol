...
contract ManagedOptimisticOracleV2IntegrationTest is Test {
    ...
    function setUp() public {
        ...
        maximumBonds[1] = ManagedOptimisticOracleV2.Bond({
            currency: currency2,
            amount: MAXIMUM_BOND
        });
    ...
    function test_CompletePriceRequestFlow() public {
        ...
        totalBond = oracle.requestManagerSetBond(
            requester,
            IDENTIFIER,
            block.timestamp,
            ancillaryData,
        ...
        vm.prank(proposer);
        totalBond = oracle.proposePriceFor(
            proposer,
            requester,
            IDENTIFIER,
            block.timestamp,
    ...
    function test_MulticallComplexScenario() public {
        ...
        calls[0] = abi.encodeWithSelector(
            oracle.requestManagerSetBond.selector,
            requester,
            IDENTIFIER,
            block.timestamp,
            ancillaryData,
        ...
        calls[1] = abi.encodeWithSelector(
            oracle.requestManagerSetCustomLiveness.selector,
            requester,
            IDENTIFIER,
            block.timestamp,
            ancillaryData,
