...
import {ManagedOptimisticOracleV2ProductionUpgradeChecks} from "./ManagedOptimisticOracleV2ProductionUpgradeChecks.sol";
...
contract DeployManagedOptimisticOracleV2ProductionImplementation is
    Script,
    ManagedOptimisticOracleV2ProductionUpgradeChecks
{
    function run() external {
        ...
        require(
            keccak256(type(ManagedOptimisticOracleV2).creationCode) == TARGET_CREATION_CODEHASH,
...
contract PrepareManagedOptimisticOracleV2ProductionSafeUpgrade is
    Script,
    ManagedOptimisticOracleV2ProductionUpgradeChecks
{
    function run() external {
...
contract VerifyManagedOptimisticOracleV2ProductionUpgrade is
    Script,
    ManagedOptimisticOracleV2ProductionUpgradeChecks
{
